...
/**
 * PHAR build script for lphenom/cache.
 *
 * Packages src/ + vendor/ into a self-contained PHAR archive.
 *
...
$pharFile = $buildDir . '/lphenom-cache.phar';

if (file_exists($pharFile)) {
    unlink($pharFile);
}

$phar = new Phar($pharFile, 0, 'lphenom-cache.phar');
$phar->startBuffering();
...
$stub = <<<'STUB'
<?php
Phar::mapPhar('lphenom-cache.phar');
require 'phar://lphenom-cache.phar/vendor/autoload.php';
__HALT_COMPILER();
STUB;
